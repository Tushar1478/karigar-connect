...
const ARTISANS = [
  { img: artisan1, name: "Ramesh Suthar", trade: "Carpenter",   exp: "15+ years", rating: 4.8, reviews: 120, km: "2.1", tag: "Woodwork Specialist" },
  { img: artisan2, name: "Shabana Bano",  trade: "Tailor",      exp: "12+ years", rating: 4.9, reviews: 98,  km: "1.4", tag: "Stitching Expert" },
  { img: artisan3, name: "Irfan Khan",    trade: "Electrician", exp: "10+ years", rating: 4.7, reviews: 76,  km: "3.2", tag: "Home Wiring Expert" },
  { img: artisan4, name: "Pooja Prajapat",trade: "Potter",      exp: "8+ years",  rating: 4.6, reviews: 64,  km: "4.5", tag: "Pottery Artisan" },
];

const TRUST = [
  { icon: ShieldCheck,   title: "Verified & trusted", body: "Every artisan is verified for your safety." },
  { icon: MapPin,        title: "Local & nearby",     body: "Find skilled people right in your area." },
  { icon: CreditCard,    title: "Secure payments",    body: "Safe, secure & hassle free transactions." },
  { icon: MessageSquare, title: "Always here",        body: "Our support team is always with you." },
];
...
export default function Landing() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.cream, color: C.ink, fontFamily: "'Plus Jakarta Sans',sans-serif", display: "flex" }}>
      <style>{`
        .kh-side { display:none; }
