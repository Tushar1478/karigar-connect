...
const SignupCustomer = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    signupCustomer({ name: form.name, email: form.email, phone: form.phone, location: form.location });
    navigate('/customer');
  };
...
const SignupKarigar = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    signupKarigar({ name: form.name, email: form.email, phone: form.phone, skill: form.skill, experience: Number(form.experience), location: form.location, price: Number(form.price), description: form.description });
