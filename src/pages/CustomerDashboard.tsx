...
import { mockKarigars } from '@/data/mockData';
...
const CustomerDashboard = () => {
  ...
  const filtered = useMemo(() => {
    ...
    if (ratingFilter !== 'all') list = list.filter(k => k.rating >= Number(ratingFilter));
    if (priceSort === 'low') list = [...list].sort((a, b) => a.price - b.price);
    if (priceSort === 'high') list = [...list].sort((a, b) => b.price - a.price);
    return list;
  }, [search, skillFilter, ratingFilter, priceSort]);
